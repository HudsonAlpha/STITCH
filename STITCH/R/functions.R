...
#' @param keep_first_n_haps_constant Number of haplotypes to keep constant (excludes them from the EM update)
...
STITCH <- function(
    ...
    validate_niterations_and_splitReadIterations(niterations, splitReadIterations)
